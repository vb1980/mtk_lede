...
function index()
    ...
    entry({"admin", "network", "netmode", "net_cfg"}, call("net_cfg"))
    entry({"admin", "network", "wifi", "get_wps_info"}, call("get_WPS_Info")).leaf = true
    entry({"admin", "network", "wifi", "get_wifi_pin"}, call("get_wifi_pin")).leaf = true
    entry({"admin", "network", "wifi", "set_wifi_gen_pin"}, call("set_wifi_gen_pin")).leaf = true
    ...
    entry({"admin", "network", "wifi", "apcli_get_wps_status"}, call("apcli_get_wps_status")).leaf = true;
    ...
    entry({"admin", "network", "wifi", "apcli_wps_get_pincode"}, call("apcli_wps_get_pincode")).leaf = true;
...
function get_HT_ext_channel_list()
    ...
    elseif mtkwifi.band(mode) == "2.4G" then
